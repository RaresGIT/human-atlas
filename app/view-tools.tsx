...
export function ViewTools({state,onChange,onCapture}:{state:SceneState;onChange:(update:(s:SceneState)=>SceneState)=>void;onCapture?:()=>void}){
 return <details className="view-tools"><summary>Appearance and cutaway</summary><div className="tool-fields">
